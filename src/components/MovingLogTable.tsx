...
export const MovingLogTable = memo(
	({ movingLogs }: { movingLogs: LocationData[] }) => {
		return (
			<div className="overflow-auto max-h-96 overscroll-none border border-gray-200 dark:border-white/15 rounded-md overflow-hidden">
				<table className="bg-white dark:bg-white/5 w-full">
					<thead className="sticky top-0 bg-white dark:bg-white/5 border-b-1 borer-b-gray-200 dark:border-white/15">
						<tr>
